 ...
 * @author link
 */
public class FicheroRSA extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cifrar / Descifrar Fichero RSA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FicheroRSA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FicheroRSA().setVisible(true);
            }
        });
    }
    ...
    private void cifrar() {
        ...
        if (seleccion == JFileChooser.APPROVE_OPTION) {
            ...
            if (seleccion == JFileChooser.APPROVE_OPTION) {
                ...
                c.cifrarFicheroRSA(this.fichero, destino, clavePublica);
    ...
    private void descifrar() {
        ...
        if (seleccion == JFileChooser.APPROVE_OPTION) {
            ...
            if (seleccion == JFileChooser.APPROVE_OPTION) {
                ...
                Cifrador c = Cifrador.nuevoCifrador();
                c.cifrarFicheroRSA(this.fichero, destino, clavePrivada);
